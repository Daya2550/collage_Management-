...
//logic for feche the data database 
   public void fetchData(String roll) {
	...
	public student() {
		...
		JLabel lblNewLabel = new JLabel("Attendance Section");
		lblNewLabel.setForeground(new Color(0, 128, 255));
		lblNewLabel.setFont(new Font("Sylfaen", Font.BOLD, 60));
		lblNewLabel.setBounds(259, 21, 545, 101);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				connectToDatabase();
				   ...
				   totalst.setText("Total Number of Lecture :"+total2);
				   presentst.setText("You are Present :"+present2);
		...
		btnNewButton_1.setBounds(476, 596, 164, 31);
		contentPane.add(btnNewButton_1);
		
		JButton btnNewButton_2 = new JButton("All Subjects ");
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				allstudent h=new allstudent();
        		h.setVisible(true);
        		dispose();	
			}
		});
		btnNewButton_2.setFont(new Font("Tahoma", Font.BOLD, 20));
		btnNewButton_2.setBounds(37, 71, 174, 31);
		...
		btnNewButton_1_1.setBounds(866, 596, 164, 31);
		...
		btnNewButton_1_1_1.setBounds(678, 596, 164, 31);
